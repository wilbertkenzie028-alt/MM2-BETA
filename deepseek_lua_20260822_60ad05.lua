...
function ToggleKnifeSA(enabled)
    ...
    task.spawn(function()
        if enabled then
            ...
            _KnifeSA_activate()
            print("[Knife SA] ON")
            Notify("KNIFE SA", "ON - Klik kanan untuk lempar", 2)
            _toggleLock = false
        else
            _KnifeSA_deactivate()
            print("[Knife SA] OFF")
...
-- ================================================================
-- KEYBIND - Tekan F untuk toggle Knife SA (SINGLE INSTANCE)
-- ================================================================
if not _keybindConnected then
    ...
    print("[Knife SA] Keybind F terdaftar")
end
...
print("========================================")
print("  UI Draggable di pojok kiri atas")
print("  Klik tombol ON/OFF atau Tekan F")
print("  Klik Kanan untuk lempar dengan SA")
print("  Bekerja hanya di Murder Mystery 2")
print("========================================")
Notify("KNIFE SA", "Tekan F / Klik UI untuk toggle | Klik Kanan lempar", 4)